...
def rhythm(function, data):
    data_new = list(map(list, data.split(" ")))
    #print(data_new)
    phrase = []
    for i in data_new:
        sum_vowels = 0
        for j in i:
            if j in 'аеёиоуыэюя':
                sum_vowels += 1
        phrase.append(sum_vowels)
    #print(phrase)
    return len(set(phrase)) == 1

vinni_data = input("Винни-Пух, вбей свое стихотворение: ")
if rhythm(True, vinni_data):
    print('Парам пам-пам')
else:
    print('Пам парам')